...
export const enhanceProfessionalSummary = async (req: AuthRequest, res: Response): Promise<Response | any> => {
   try {
...
export const enhanceJobDescription = async (req: AuthRequest, res: Response): Promise<Response | any> => {
   try {
      const { userContent } = req.body;
...
export const uploadResume = async (req: AuthRequest, res: Response): Promise<Response | any> => {
   try {
