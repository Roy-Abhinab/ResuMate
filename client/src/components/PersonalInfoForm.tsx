import { BriefcaseBusiness, Globe, LinkIcon, Mail, MapPin, Phone, User } from 'lucide-react'
...
const PersonalInfoForm = ({ data, onChange, removeBackground, setRemoveBackground }: PersonalInfoFormProps) => {
