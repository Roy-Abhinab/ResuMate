         ...
         <header className="p-8 text-white" style={{ backgroundColor: accentColor }}>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-sm ">
               ...
               {data.personal_info?.linkedin && (
                  <a target="_blank" href={data.personal_info?.linkedin} rel="noreferrer" className="flex items-center gap-2">
               ...
               {data.personal_info?.website && (
                  <a target="_blank" href={data.personal_info?.website} rel="noreferrer" className="flex items-center gap-2">
